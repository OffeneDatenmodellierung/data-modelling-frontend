 ...
 */
export function add_cads_node_to_domain(
 ...
 */
export function add_domain_to_workspace(
  workspace_json: string,
  domain_id: string,
  domain_name: string
): string;
 ...
 */
export function add_entity_to_domain_config(
  config_json: string,
  entity_type: string,
  entity_id: string
): string;
 ...
 * JSON string containing updated DataModel, or JsValue error
 */
export function add_odcs_node_to_domain(
  workspace_json: string,
  domain_id: string,
  node_json: string
): string;
 ...
 * JSON string containing updated DataModel, or JsValue error
 */
export function add_system_to_domain(
  workspace_json: string,
  domain_id: string,
  system_json: string
): string;
 ...
 */
export function check_circular_dependency(
 ...
 */
export function convert_openapi_to_odcs(
 ...
 */
export function detect_naming_conflicts(
  existing_tables_json: string,
  new_tables_json: string
): string;
 ...
 */
export function export_openapi_spec(
  content: string,
 ...
 */
export function filter_nodes_by_infrastructure_type(
  workspace_json: string,
 ...
 */
export function filter_relationships_by_infrastructure_type(
  workspace_json: string,
  infrastructure_type: string
): string;
 ...
 */
export function import_openapi_spec(
  domain_id: string,
  content: string,
 ...
 * JSON string containing Domain, or JsValue error
 */
export function migrate_dataflow_to_domain(
  dataflow_yaml: string,
 ...
 * JSON string containing updated DomainConfig, or JsValue error
 */
export function remove_entity_from_domain_config(
  config_json: string,
  entity_type: string,
  entity_id: string
): string;
 ...
 */
export function validate_no_self_reference(
  source_table_id: string,
  target_table_id: string
): string;
...
export interface InitOutput {
  ...
  readonly add_domain_to_workspace: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly add_entity_to_domain_config: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly add_odcs_node_to_domain: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly analyze_openapi_conversion: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly check_circular_dependency: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly convert_openapi_to_odcs: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly detect_naming_conflicts: (
    a: number,
    b: number,
    c: number,
    d: number
  ...
  readonly filter_by_tags: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly filter_nodes_by_infrastructure_type: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly filter_nodes_by_owner: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly filter_relationships_by_infrastructure_type: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly filter_relationships_by_owner: (
    a: number,
    b: number,
    c: number,
    d: number
  ...
  readonly import_from_sql: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly import_openapi_spec: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly migrate_dataflow_to_domain: (
    a: number,
    b: number,
    c: number,
    d: number
  ...
  readonly remove_domain_from_workspace: (
    a: number,
    b: number,
    c: number,
    d: number
  ) => [number, number, number, number];
  readonly remove_entity_from_domain_config: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly validate_no_self_reference: (
    a: number,
    b: number,
    c: number,
    d: number
