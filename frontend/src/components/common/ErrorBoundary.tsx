 ...
 * Note: This is a wrapper around the class component since React Error Boundaries
 * must be class components. For functional components, use the ErrorBoundary class directly.
 */
